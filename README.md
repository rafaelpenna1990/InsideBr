...
1. Rodar `npm run inspect-cvm` e me mandar as colunas
2. Eu escrevo o `fetchVlmo.js` completo (parser + inserção no banco)
3. Testamos populando o banco com dados reais
4. Conectamos o app Expo (InsideBR) nesses endpoints reais em vez do mock
